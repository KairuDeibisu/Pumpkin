...
pub mod v0_2 {
    ...
    bindgen!({
        ...
        imports: {
            ...
            "pumpkin:plugin/datapack@0.2.0.[method]datapack-manager.enable-pack": async | store | trappable,
            "pumpkin:plugin/datapack@0.2.0.[method]datapack-manager.execute-function": async | store | trappable,
            "pumpkin:plugin/datapack@0.2.0.[method]datapack-manager.reload": async | store | trappable,
            "pumpkin:plugin/ipc@0.2.0.send-ipc-message": async | store | trappable,
            "pumpkin:plugin/player@0.2.0.[method]player.add-effect": async | store | trappable,
            "pumpkin:plugin/player@0.2.0.[method]player.add-experience-levels": async | store | trappable,
            "pumpkin:plugin/player@0.2.0.[method]player.add-experience-points": async | store | trappable,
            "pumpkin:plugin/player@0.2.0.[method]player.award-advancement": async | store | trappable,
            "pumpkin:plugin/player@0.2.0.[method]player.award-advancement-criterion": async | store | trappable,
            "pumpkin:plugin/player@0.2.0.[method]player.ban": async | store | trappable,
            "pumpkin:plugin/player@0.2.0.[method]player.ban-ip": async | store | trappable,
            "pumpkin:plugin/player@0.2.0.[method]player.damage": async | store | trappable,
            "pumpkin:plugin/player@0.2.0.[method]player.has-permission": async | store | trappable,
            "pumpkin:plugin/player@0.2.0.[method]player.heal": async | store | trappable,
            "pumpkin:plugin/player@0.2.0.[method]player.kill": async | store | trappable,
            "pumpkin:plugin/player@0.2.0.[method]player.open-ender-chest": async | store | trappable,
            "pumpkin:plugin/player@0.2.0.[method]player.open-gui": async | store | trappable,
            "pumpkin:plugin/player@0.2.0.[method]player.respawn": async | store | trappable,
            "pumpkin:plugin/player@0.2.0.[method]player.set-experience-level": async | store | trappable,
            "pumpkin:plugin/player@0.2.0.[method]player.set-experience-points": async | store | trappable,
            "pumpkin:plugin/player@0.2.0.[method]player.set-experience-progress": async | store | trappable,
            "pumpkin:plugin/player@0.2.0.[method]player.set-food-level": async | store | trappable,
            "pumpkin:plugin/player@0.2.0.[method]player.set-gamemode": async | store | trappable,
            "pumpkin:plugin/player@0.2.0.[method]player.set-permission-level": async | store | trappable,
            "pumpkin:plugin/player@0.2.0.[method]player.teleport": async | store | trappable,
            "pumpkin:plugin/player@0.2.0.[method]player.teleport-world": async | store | trappable,
            "pumpkin:plugin/player@0.2.0.[method]java-player.show-dialog": async | store | trappable,
            "pumpkin:plugin/player@0.2.0.[method]java-player.clear-dialog": async | store | trappable,
            "pumpkin:plugin/player@0.2.0.[method]java-player.kick": async | store | trappable,
            "pumpkin:plugin/player@0.2.0.[method]bedrock-player.kick": async | store | trappable,
            "pumpkin:plugin/server@0.2.0.[method]ban-manager.ban-ip": async | store | trappable,
            "pumpkin:plugin/server@0.2.0.[method]ban-manager.ban-player": async | store | trappable,
            "pumpkin:plugin/server@0.2.0.[method]op-manager.deop-player": async | store | trappable,
            "pumpkin:plugin/server@0.2.0.[method]op-manager.op-player": async | store | trappable,
            "pumpkin:plugin/server@0.2.0.[method]server.broadcast": async | store | trappable,
            "pumpkin:plugin/server@0.2.0.[method]server.create-world": async | store | trappable,
            "pumpkin:plugin/server@0.2.0.[method]server.execute-command": async | store | trappable,
            "pumpkin:plugin/server@0.2.0.[method]server.save-all": async | store | trappable,
            "pumpkin:plugin/server@0.2.0.[method]server.unload-world": async | store | trappable,
            "pumpkin:plugin/server@0.2.0.[method]whitelist-manager.set-enabled": async | store | trappable,
            "pumpkin:plugin/world@0.2.0.[method]entity.add-passenger": async | store | trappable,
            "pumpkin:plugin/world@0.2.0.[method]entity.eject-passengers": async | store | trappable,
            "pumpkin:plugin/world@0.2.0.[method]entity.remove-passenger": async | store | trappable,
            "pumpkin:plugin/world@0.2.0.[method]entity.set-swimming": async | store | trappable,
            "pumpkin:plugin/world@0.2.0.[method]entity.set-vehicle": async | store | trappable,
            "pumpkin:plugin/world@0.2.0.[method]entity.teleport": async | store | trappable,
            "pumpkin:plugin/world@0.2.0.[method]living-entity.damage": async | store | trappable,
            "pumpkin:plugin/world@0.2.0.[method]mob.clear-ai-goals": async | store | trappable,
            "pumpkin:plugin/world@0.2.0.[method]world.create-explosion": async | store | trappable,
            "pumpkin:plugin/world@0.2.0.[method]world.save": async | store | trappable,
            "pumpkin:plugin/world@0.2.0.[method]world.set-block": async | store | trappable,
            "pumpkin:plugin/world@0.2.0.[method]world.set-block-by-id": async | store | trappable,
            "pumpkin:plugin/world@0.2.0.[method]world.set-block-by-name": async | store | trappable,
            "pumpkin:plugin/world@0.2.0.[method]world.set-block-state": async | store | trappable,
