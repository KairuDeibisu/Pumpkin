...
use crate::plugin::loader::wasm::wasm_host::wit::v0_2::pumpkin::plugin::enchantments::{
    CustomEnchantment as WitCustomEnchantment, EnchantmentManager as WitEnchantmentManager,
};
use crate::plugin::loader::wasm::wasm_host::wit::v0_2::pumpkin::plugin::recipe::RecipeManager as WitRecipeManager;
...
impl pumpkin::plugin::server::HostServer for PluginHostState {
    ...
    async fn get_advancement(
        ...
        let Some(advancement) =
            crate::plugin::loader::wasm::wasm_host::wit::v0_2::advancement::find_advancement(&id)
        else {
            return Ok(None);
        };
        crate::plugin::loader::wasm::wasm_host::wit::v0_2::advancement::to_wasm_advancement_info(
            self,
            advancement,
        )
        .map(Some)
