...
use crate::plugin::loader::wasm::wasm_host::wit::v0_2::pumpkin::plugin::common::Position as WitPosition;
use crate::plugin::loader::wasm::wasm_host::wit::v0_2::pumpkin::plugin::game_rules::{
    GameRule as WitGameRule, GameRuleValue as WitGameRuleValue,
};
use crate::plugin::loader::wasm::wasm_host::wit::v0_2::pumpkin::plugin::world::{
...
use crate::plugin::loader::wasm::wasm_host::{
    ...
    wit::v0_2::pumpkin::{self, plugin::world::World},
};
...
impl WasmChunkGenerator {
    fn invoke_phase(
        ...
        let function = match self.plugin.plugin_instance.as_ref() {
            crate::plugin::loader::wasm::wasm_host::PluginInstance::V0_2(plugin) => {
