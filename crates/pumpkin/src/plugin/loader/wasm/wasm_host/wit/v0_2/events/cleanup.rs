    ...
    match event {
        ...
        Event::DialogShowEvent(data) => {
            ...
            for body in &data.dialog.body {
                match body {
                    crate::plugin::loader::wasm::wasm_host::wit::v0_2::pumpkin::plugin::java_dialogs::DialogBody::PlainMessage(c) => cleanup_text_component(state, c),
                    crate::plugin::loader::wasm::wasm_host::wit::v0_2::pumpkin::plugin::java_dialogs::DialogBody::Item(item) => cleanup_item_stack(state, item),
                }
            }
            for input in &data.dialog.inputs {
                use crate::plugin::loader::wasm::wasm_host::wit::v0_2::pumpkin::plugin::java_dialogs::DialogInput;
                match input {
            ...
            for link in &data.dialog.links {
                if let crate::plugin::loader::wasm::wasm_host::wit::v0_2::pumpkin::plugin::java_dialogs::LinkLabel::Custom(c) = &link.label {
