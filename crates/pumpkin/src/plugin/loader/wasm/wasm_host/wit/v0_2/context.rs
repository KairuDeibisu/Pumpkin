...
impl pumpkin::plugin::context::HostContext for PluginHostState {
    ...
    async fn get_marketplace_metadata(
        ...
        Ok(self.marketplace_metadata.as_ref().map(|metadata| MarketplaceMetadata {
            marketplace_url: metadata.marketplace_url.clone(),
            plugin_id: metadata.plugin_id.clone(),
            plugin_name: metadata.plugin_name.clone(),
            version: metadata.version.clone(),
            dev_id: metadata.dev_id.clone(),
            dev_name: metadata.dev_name.clone(),
            is_paid: metadata.is_paid,
            user_id: metadata.user_id.clone(),
            license_key: metadata.license_key.clone(),
