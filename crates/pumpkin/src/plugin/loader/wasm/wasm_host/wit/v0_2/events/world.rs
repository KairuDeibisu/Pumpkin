    ...
    for crate::plugin::api::events::world::async_structure_generate::AsyncStructureGenerateEvent
{
    fn to_wasm_event(&self, _state: &mut PluginHostState) -> Event {
        Event::AsyncStructureGenerateEvent(crate::plugin::loader::wasm::wasm_host::wit::v0_2::pumpkin::plugin::event::AsyncStructureGenerateEventData {
...
{
    fn to_wasm_event(&self, _state: &mut PluginHostState) -> Event {
        Event::AsyncStructureSpawnEvent(crate::plugin::loader::wasm::wasm_host::wit::v0_2::pumpkin::plugin::event::AsyncStructureSpawnEventData {
            world_name: self.world_name.clone(),
            structure_name: self.structure_name.clone(),
            pos: to_wasm_block_position(self.pos),
            cancelled: self.cancelled,
...
impl ToFromWasmEvent for crate::plugin::api::events::world::chunk_populate::ChunkPopulateEvent {
    fn to_wasm_event(&self, _state: &mut PluginHostState) -> Event {
        Event::ChunkPopulateEvent(crate::plugin::loader::wasm::wasm_host::wit::v0_2::pumpkin::plugin::event::ChunkPopulateEventData {
...
impl ToFromWasmEvent for crate::plugin::api::events::world::chunk_unload::ChunkUnloadEvent {
    fn to_wasm_event(&self, _state: &mut PluginHostState) -> Event {
        Event::ChunkUnloadEvent(crate::plugin::loader::wasm::wasm_host::wit::v0_2::pumpkin::plugin::event::ChunkUnloadEventData {
            chunk_x: self.chunk_pos.x,
            chunk_z: self.chunk_pos.y,
            cancelled: self.cancelled,
        })
...
impl ToFromWasmEvent for crate::plugin::api::events::world::entities_load::EntitiesLoadEvent {
    fn to_wasm_event(&self, _state: &mut PluginHostState) -> Event {
        Event::EntitiesLoadEvent(crate::plugin::loader::wasm::wasm_host::wit::v0_2::pumpkin::plugin::event::EntitiesLoadEventData {
            chunk_x: self.chunk_pos.x,
            chunk_z: self.chunk_pos.y,
...
impl ToFromWasmEvent for crate::plugin::api::events::world::entities_unload::EntitiesUnloadEvent {
    fn to_wasm_event(&self, _state: &mut PluginHostState) -> Event {
        Event::EntitiesUnloadEvent(crate::plugin::loader::wasm::wasm_host::wit::v0_2::pumpkin::plugin::event::EntitiesUnloadEventData {
            chunk_x: self.chunk_pos.x,
            chunk_z: self.chunk_pos.y,
            entity_count: self.entity_count as u32,
            cancelled: self.cancelled,
...
impl ToFromWasmEvent for crate::plugin::api::events::world::generic_game::GenericGameEvent {
    fn to_wasm_event(&self, _state: &mut PluginHostState) -> Event {
        Event::GenericGameEvent(crate::plugin::loader::wasm::wasm_host::wit::v0_2::pumpkin::plugin::event::GenericGameEventData {
...
impl ToFromWasmEvent for crate::plugin::api::events::world::loot_generate::LootGenerateEvent {
    fn to_wasm_event(&self, _state: &mut PluginHostState) -> Event {
        Event::LootGenerateEvent(crate::plugin::loader::wasm::wasm_host::wit::v0_2::pumpkin::plugin::event::LootGenerateEventData {
...
impl ToFromWasmEvent for crate::plugin::api::events::world::portal_create::PortalCreateEvent {
    fn to_wasm_event(&self, _state: &mut PluginHostState) -> Event {
        Event::PortalCreateEvent(crate::plugin::loader::wasm::wasm_host::wit::v0_2::pumpkin::plugin::event::PortalCreateEventData {
...
impl ToFromWasmEvent for crate::plugin::api::events::world::structure_grow::StructureGrowEvent {
    fn to_wasm_event(&self, _state: &mut PluginHostState) -> Event {
        Event::StructureGrowEvent(crate::plugin::loader::wasm::wasm_host::wit::v0_2::pumpkin::plugin::event::StructureGrowEventData {
            pos: to_wasm_block_position(self.block_pos),
...
impl ToFromWasmEvent for crate::plugin::api::events::world::time_skip::TimeSkipEvent {
    fn to_wasm_event(&self, _state: &mut PluginHostState) -> Event {
        Event::TimeSkipEvent(crate::plugin::loader::wasm::wasm_host::wit::v0_2::pumpkin::plugin::event::TimeSkipEventData {
...
impl ToFromWasmEvent for crate::plugin::api::events::world::world_init::WorldInitEvent {
    fn to_wasm_event(&self, state: &mut PluginHostState) -> Event {
        ...
        Event::WorldInitEvent(crate::plugin::loader::wasm::wasm_host::wit::v0_2::pumpkin::plugin::event::WorldInitEventData {
            target_world,
        })
    }
...
impl ToFromWasmEvent for crate::plugin::api::events::world::world_save::WorldSaveEvent {
    fn to_wasm_event(&self, _state: &mut PluginHostState) -> Event {
        Event::WorldSaveEvent(crate::plugin::loader::wasm::wasm_host::wit::v0_2::pumpkin::plugin::event::WorldSaveEventData {
            world_name: self.world_name.clone(),
            cancelled: self.cancelled,
        })
    }
...
impl ToFromWasmEvent for crate::plugin::api::events::world::lightning_strike::LightningStrikeEvent {
    fn to_wasm_event(&self, _state: &mut PluginHostState) -> Event {
        Event::LightningStrikeEvent(crate::plugin::loader::wasm::wasm_host::wit::v0_2::pumpkin::plugin::event::LightningStrikeEventData {
            position: crate::plugin::loader::wasm::wasm_host::wit::v0_2::events::to_wasm_position(self.position),
    ...
    fn from_wasm_event(event: Event, _state: &mut PluginHostState) -> Self {
        match event {
            Event::LightningStrikeEvent(data) => Self {
                position:
                    crate::plugin::loader::wasm::wasm_host::wit::v0_2::events::from_wasm_position(
                        data.position,
                    ),
