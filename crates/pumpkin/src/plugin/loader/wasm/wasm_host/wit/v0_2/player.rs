...
use crate::plugin::loader::wasm::wasm_host::wit::v0_2::pumpkin::plugin::java_dialogs::Dialog;
use crate::{
    entity::{
        EntityBase,
        player::{
...
impl pumpkin::plugin::player::HostPlayer for PluginHostState {
    ...
    async fn set_camera(
        ...
        entity: Option<
            Resource<
                crate::plugin::loader::wasm::wasm_host::wit::v0_2::pumpkin::plugin::world::Entity,
            >,
        >,
    ) -> wasmtime::Result<()> {
        let player = player_from_resource(self, &player)?;
        if let Some(target_res) = entity {
            let target =
                crate::plugin::loader::wasm::wasm_host::wit::v0_2::entity::entity_from_resource(
                    self,
                    &target_res,
                )?;
